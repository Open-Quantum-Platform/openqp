...
OUT = '/bighome/alireza/openqp-nac/tools/nac_validation/data_snapshots/p12_identity2.npz'
EPS = 1.0e-4     # MO-mixing step for R
DX = 1.0e-3      # nuclear step
OVTAG = 'OQP::overlap_mo_non_orthogonal'

r = Runner(input_file=INP,
           log='/bighome/alireza/openqp-nac/tools/nac_validation/p12_identity2.log')
r.run()
mol = r.mol
