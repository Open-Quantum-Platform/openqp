...
def test_every_wf_methods_example_has_a_committed_oqp_twin():
    # 25 since the analytic SC-NEVPT2 gradient added H4_SC-NEVPT2_grad.inp
    ...
    # and H4_SC-NEVPT2_optimize.inp (the same derivative driving runtype=
