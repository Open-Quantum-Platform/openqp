...
class DDXSCFIntegrationSeamTests(unittest.TestCase):
    ...
    def test_reference_scf_pcm_runtime_payload_records_validated_potential_and_epcm(self):
        ...
        self.assertEqual(payload["packed_ao_length"], 3)
        self.assertEqual(payload["expected_packed_ao_length"], 3)
        self.assertEqual(payload["packed_ao_shape_formula"], "nbf * (nbf + 1) / 2")
    ...
    def test_reference_scf_pcm_reaction_potential_from_payload_requires_reviewed_scope(self):
        ...
        self.assertEqual(reviewed["packed_ao_length"], 3)
        self.assertEqual(reviewed["expected_packed_ao_length"], 3)
        self.assertEqual(reviewed["packed_ao_shape_formula"], "nbf * (nbf + 1) / 2")
    ...
    def test_reference_scf_pcm_calc_fock_handoff_exposes_only_guarded_keyword_argument(self):
        ...
        self.assertEqual(handoff["expected_packed_ao_length"], 3)
        self.assertEqual(handoff["packed_ao_shape_formula"], "nbf * (nbf + 1) / 2")
