...
module zvector_common
  ...
  type :: zv_opts_t
    logical :: warm_on = .true.    !< warm-start across geometry/MD steps
    logical :: prog_on = .true.    !< progressive (iteration-dependent) screening
    logical :: diag_on = .true.    !< Jacobi cold-start guess x0 = M^-1 rhs
