...
!   BOTH passes.  The energy adds them in neither: int2_mrsf_data_t_update's
!   cur_pass==2 branch digests slot 7 (ball) alone, so slots 1-6 carry a
!   pass-1 contribution only.  Adding them again against the attenuated
