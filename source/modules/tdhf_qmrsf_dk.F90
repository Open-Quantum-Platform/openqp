...
!>         the paper, at the integral level).
...
!>     - the active-space determination from the quintet reference, the
!>       qmrsf_active_integrals call, and the log/dump discipline.
...
contains
  ...
  subroutine tdhf_qmrsf_dk(infos)
    ...
    ! ---- Active-space integrals (int2 reuse path) ----------------------------
...
!===============================================================================
  ...
  !> Fixed-name validation dump consumed by oqp.library.qmrsf_results.
  subroutine dk_write_dump(h_act, eri4, ecore, omega_d, cas_ref, dressed, adiab, &
    ...
    !  active integrals (for the AO oracle gate)
