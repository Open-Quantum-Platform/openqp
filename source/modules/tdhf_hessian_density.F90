...
contains
  ...
  subroutine build_tdhf_relaxed_density_derivatives(infos, umat, eps_deriv, &
    ...
    do k=1,ncoord
      ...
      call add_symmetric_ov_density(c,umat(:,:,k),zm,dzm,dp_relaxed(:,:,k),work,1.0_dp)
    ...
    deallocate(um,vm,zm,tm,pm,wm,dum,dvm,dzm,dtm,dpm,dwm,hp,hm,ht,dhp,dhm,dht, &
               mu,mv,dm_u,dm_v,work)
  end subroutine

  subroutine form_w_and_derivative(u,v,z,duv,dvv,dzv,eps,deps,omega,domega, &
                                    hp,hm,ht,dhp,dhm,dht,w,dw)
