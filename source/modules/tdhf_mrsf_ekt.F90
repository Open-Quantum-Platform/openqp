...
contains
  ...
  subroutine tdhf_mrsf_ekt(infos, electron_affinity)
    ...
    ! Z-vector.  OQP_td_p stores the relaxed alpha/beta difference-density
    ! corrections in the AO basis; combine them with the reference alpha/beta
    ! densities before transforming to the neutral-state MO basis for the
    ! Dyson-orbital generalized eigenproblem.
    ...
    density_mo = density_alpha_mo + density_beta_mo
