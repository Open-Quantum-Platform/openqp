...
def _check_runtype(config: dict[str, Any], report: CheckReport,
    ...
    # call per-state gradients), and representative HF plus H2CO/BLYP/BHHLYP UMRSF gradients are
    # finite-difference validated. The MECI/MECP/TCI penalty and updating-branching-plane methods are coupling-free (two or
