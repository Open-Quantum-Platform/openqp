...
RUNTYPE_LOG_CATEGORIES = {
    "energy": (INPUT_REFERENCE, CONVERGENCE, ENERGIES, TERMINATION),
    "ekt": (INPUT_REFERENCE, CONVERGENCE, ENERGIES, TERMINATION),
    "soc": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
            GRADIENTS_PROPERTIES, TERMINATION),
    "grad": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
             GRADIENTS_PROPERTIES, TERMINATION),
    "hess": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
             GRADIENTS_PROPERTIES, TERMINATION),
    "thermo": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
               GRADIENTS_PROPERTIES, TERMINATION),
    "nac": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
            GRADIENTS_PROPERTIES, TERMINATION),
    "nacme": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
              GRADIENTS_PROPERTIES, TERMINATION),
    "bp": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
           GRADIENTS_PROPERTIES, TERMINATION),
    "prop": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
             GRADIENTS_PROPERTIES, TERMINATION),
    "data": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
             GRADIENTS_PROPERTIES, TERMINATION),
    "optimize": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
                 GRADIENTS_PROPERTIES, TERMINATION),
    "meci": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
             GRADIENTS_PROPERTIES, TERMINATION),
    "mecp": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
             GRADIENTS_PROPERTIES, TERMINATION),
    "tci": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
            GRADIENTS_PROPERTIES, TERMINATION),
    "mep": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
            GRADIENTS_PROPERTIES, TERMINATION),
    "ts": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
           GRADIENTS_PROPERTIES, TERMINATION),
    "irc": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
            GRADIENTS_PROPERTIES, TERMINATION),
    "neb": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
            GRADIENTS_PROPERTIES, TERMINATION),
    "namd": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
             GRADIENTS_PROPERTIES, TERMINATION),
    "md": (INPUT_REFERENCE, CONVERGENCE, ENERGIES,
           GRADIENTS_PROPERTIES, TERMINATION),
}
