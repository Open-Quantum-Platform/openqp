...
class OpenQpQMMM:
    ...
    #: residual into ESPF-charge noise of 1e-6 to 1e-5 e (the damped loop can
    #: also settle into a two-state alternation of that size), so IMAGE_TOL can
    #: be out of reach while the energy no longer moves.  After
