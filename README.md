...
| --- | --- | --- | --- |
| Analytic nuclear gradients | MRSF/SF/TDDFT, HF/DFT, RHF-based MP2, state-specific CASSCF, and CASPT2/XMS-CASPT2 | State-specific derivatives for `grad`, optimization, reaction paths, and dynamics; the CASPT2 route solves the amplitude, CI, XMS-rotation and orbital-response equations, at a cost independent of the number of nuclei | [Overview](https://open-quantum-platform.github.io/openqp-docs/capabilities/) |
| Numerical nuclear gradients | SA-CASSCF and the CASPT2/NEVPT2/QDPT2 variants without an analytic derivative | Central differences of converged energies for `grad`, `optimize`, `ts`, `mep`, and `irc`; also the fallback whenever the analytic CASPT2 route does not apply | [Examples](examples/WF_methods) |
